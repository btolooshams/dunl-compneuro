    ...
    for data_path in data_path_list:
        ...
        for neuron_ctr in range(num_neurons):
            out_path_name = os.path.join(
                out_path,
                "vertical_codes_vs_reward_{}_neuron{}_{}.svg".format(
...
def plot_code_vs_rew_single_neuron(
    ...
    fig, axn = plt.subplots(3, 1, sharex=True, sharey=False, figsize=params["figsize"])
    ...
    for kernel_ctr in range(params["kernel_num"]):
        ...
        plt.subplot(params["kernel_num"], 1, kernel_ctr + 1)
