...
def init_params():
    ...
    parser.add_argument(
        ...
        help="data path list",
        default=[
            "../data/local-deconv-calscenario-shorttrial-simulated/simulated_1neurons_25trials_25msbinres_8Hzbaseline_nov_general_format_processed_kernellength16_kernelnum2_trainready.pt",
            "../data/local-deconv-calscenario-shorttrial-simulated/simulated_1neurons_50trials_25msbinres_8Hzbaseline_nov_general_format_processed_kernellength16_kernelnum2_trainready.pt",
            "../data/local-deconv-calscenario-shorttrial-simulated/simulated_1neurons_100trials_25msbinres_8Hzbaseline_nov_general_format_processed_kernellength16_kernelnum2_trainready.pt",
            "../data/local-deconv-calscenario-shorttrial-simulated/simulated_1neurons_200trials_25msbinres_8Hzbaseline_nov_general_format_processed_kernellength16_kernelnum2_trainready.pt",
            "../data/local-deconv-calscenario-shorttrial-simulated/simulated_1neurons_400trials_25msbinres_8Hzbaseline_nov_general_format_processed_kernellength16_kernelnum2_trainready.pt",
            "../data/local-deconv-calscenario-shorttrial-simulated/simulated_1neurons_800trials_25msbinres_8Hzbaseline_nov_general_format_processed_kernellength16_kernelnum2_trainready.pt",
            "../data/local-deconv-calscenario-shorttrial-simulated/simulated_1neurons_1600trials_25msbinres_8Hzbaseline_nov_general_format_processed_kernellength16_kernelnum2_trainready.pt",
        ],
    )
    parser.add_argument(
        "--out-path",
    ...
    parser.add_argument(
        ...
        default="local_deconv_calscenario_shorttrial_for_lfads",
    )
    parser.add_argument(
        "--batch-size",
        type=int,
