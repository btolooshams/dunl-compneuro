...
def init_params():
    ...
    parser.add_argument(
        ...
        default=[50, 55],  # Let see what the SNR is given the baseline activity.
    )
    parser.add_argument(
        "--code-amplitude-std",
        type=float,
...
def main(params):
    ...
    if 1:
        if params["train_or_test"] == "train":
            save_path = "{}/simulated_{}neurons_{}trials_{}msbinres_{}Hzbaseline_long_general_format_processed.npy".format(
                params["out_path"],
                params["num_neurons"],
                params["num_trials"],
            ...
            save_path = "{}/test_simulated_{}neurons_{}trials_{}msbinres_{}Hzbaseline_long_general_format_processed.npy".format(
                params["out_path"],
                params["num_neurons"],
                params["num_trials"],
                params["time_bin_resolution"],
