...
def main():
    ...
    for neuron_ctr in range(num_neurons):
        ...
        train_x, train_xhat, train_yhat = get_xxhat(net, dataset, params, neuron_ctr)
        train_x_init, train_xhat_init, train_yhat_init = get_xxhat(
            net_init, dataset, params, neuron_ctr
        )

        test_x, test_xhat, test_yhat = get_xxhat(net, test_dataset, params, neuron_ctr)
        ...
        for trial in range(train_num_trials):
            ...
            plot_whisker_code_and_raw(
                train_x_init[trial, 0],
                train_xhat_init[trial, 0],
                train_raster_neuron[trial],
                train_smooth_raster[trial, 0],
                train_yhat_init[trial],
                params,
                os.path.join(
                    neuron_out_path,
                    "a_code_train_neuron{}_trial{}_smoothingtau{}_withinitkernel.svg".format(
                        neuron_ctr,
                        trial,
                        params["smoothing_tau"],
                    ),
        ...
        for trial in range(test_num_trials):
            ...
            plot_whisker_code_and_raw(
                ...
                os.path.join(
                    neuron_out_path,
                    "a_code_test_neuron{}_trial{}_smoothingtau{}_withinitkernel.svg".format(
                        neuron_ctr,
                        trial,
                        params["smoothing_tau"],
                    ),
